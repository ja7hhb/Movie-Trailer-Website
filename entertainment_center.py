...
Looper = media.Movie(
    ...
    "Fantasy/Thriller",
    "1h59m",
    "http://t0.gstatic.com/images?q=tbn:ANd9GcSN2OH-geb6K6TMqpahtBU_CmsoToTcB1vTt8S_fzhFRaQdJ9LV",  # NOQA
    "https://www.youtube.com/watch?v=G90QrEKh8l8"
    )
...
Brazil = media.Movie(
    ...
    "Fantasy/Thriller",
    "2h22m",
    "https://upload.wikimedia.org/wikipedia/en/e/e9/Brazil_%281985_film%29_poster.jpg",  # NOQA
